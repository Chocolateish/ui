...
export class Group extends Component {
  ...
  static get elementName() {
    return componentNameStart + "group";
  }
...
export class CollapsibleGroup extends Group {
  constructor() {
    super();
    this.appendChild((this.__container = crel("div")));
    this.appendChild((this.__collapser = crel("span"))).tabIndex = 0;
    this.__collapser.appendChild((this.__text = crel("div")));
